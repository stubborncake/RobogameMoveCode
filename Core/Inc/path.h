...
/*  @brief  Flag for losing trace near baseline area; 
    If set, main procedure would run into adjustBacktoTrace(), 
    which attempts to move back to baseline and reset the flag.
*/
#define LOST_TRACE (1)
/*在基准线附近移动时脱线的标志*/
